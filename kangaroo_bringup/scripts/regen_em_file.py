...
valid_pairs = [['4dof', 'fake-forearm'], ['5dof', 'RH8D'], ['5dof', 'no-end-effector'], ['7dof', 'gripper'], ['7dof', 'no-end-effector'],
               ['no-arm', 'cover']]
    ...
    for leg_type in legs:
        for arm_type, end_effector in valid_pairs:
                ...
                cfg = {
                    ...
                    "has_legs": leg_type != 'no-leg',
                }

                with open(em_file_path, "r") as f:
                    expanded_contents = em.expand(f.read(), cfg)

                suffix = '_' + f'{arm_type}_' + f'{end_effector}'+ '_' + f'{"with-pelvis" if has_pelvis else "no-pelvis"}_' + f'{leg_type}'
